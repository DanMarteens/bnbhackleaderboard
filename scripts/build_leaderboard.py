...
.thead,.row{display:grid;grid-template-columns:44px 1.5fr 104px 108px 78px 120px;align-items:center;gap:10px;padding:14px 18px}
...
@media(max-width:680px){.mark{font-size:15px}.h1{font-size:30px}.thead,.row{grid-template-columns:30px 1fr 80px 74px;gap:8px}
 .c24,.dqcol{display:none}.pnlcol{font-size:14px}.bad{grid-template-columns:1fr}.tools{flex-direction:column;align-items:stretch}#minv{width:100%}}
...
const cols=[['#','rank',1],['Agent','agent',0],['Value','value',1],['PnL','ret_pct',1,'pnlcol'],['24h','chg24h',1,'c24'],['DQ risk','dd_pct',1,'dqcol']];
